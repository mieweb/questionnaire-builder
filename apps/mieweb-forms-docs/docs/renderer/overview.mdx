...
<div className="p-8 bg-slate-50 rounded-lg text-center">
  ...
  <a href="https://questionnaire-dev-test.opensource.mieweb.org" target="_blank" rel="noopener noreferrer" className="renderer-demo-link button button--primary button--lg">Launch Live Demo →</a>
</div>
