...
<div style={{ padding: '2rem', backgroundColor: '#f6f8fa', borderRadius: '8px', textAlign: 'center', marginBottom: '2rem' }}>
  ...
  <a href="https://questionnaire-dev-test.opensource.mieweb.org" target="_blank" rel="noopener noreferrer" className="editor-demo-link button button--primary button--lg">Launch Live Demo →</a>
</div>
