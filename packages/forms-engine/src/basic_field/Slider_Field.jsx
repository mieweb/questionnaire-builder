                  ...
                  {options.length > 0 && (
                    <div className="mie:relative mie:pt-1">
                      ...
                      <input
                        ...
                        className="mie:w-full mie:h-1 mie:bg-mieborder mie:rounded-lg mie:appearance-none mie:cursor-pointer slider-thumb"
                      />
                      
                      {/* Scale markers and labels below */}
                      <div className="mie:relative mie:mt-2 mie:px-2">
                        <div className="mie:relative mie:h-4 mie:text-mietextmuted mie:text-center">
                                ...
                                >
                                  <span
                                    className={`mie:text-sm ${
                                      selectedIndex === index
                                        ? 'mie:text-mieprimary mie:font-semibold'
                                        : 'mie:text-mietextmuted mie:hover:text-mieprimary'
                                    }`}
                                  >
                                    {option.value}
                                  </span>
