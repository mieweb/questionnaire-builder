            ...
            <div className={`longtext-field-preview ${insideSection ? "border-b border-gray-200" : "border-0"}`}>
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 pb-4">
                ...
                <textarea
                  ...
                  className="px-3 py-2 w-full min-w-0 border border-gray-300 shadow-sm rounded-lg min-h-24 max-h-60 resize-y focus:border-blue-400 focus:ring-1 focus:ring-blue-400 outline-none transition-colors"
                  rows={4}
                />
              </div>
            </div>
